...
MONGO_DB = 'taobao_splash'

# Downloader Middleware，Scrapy-Splash 库都为我们准备好了，直接配置即可
DOWNLOADER_MIDDLEWARES = {
    # 'scrapysplashtest.middlewares.HeaderMiddleware': 355,
...
# 配置一个去重的类 DUPEFILTER_CLASS
DUPEFILTER_CLASS = 'scrapy_splash.SplashAwareDupeFilter'

# 配置一个 Cache 存储 HTTPCACHE_STORAGE
